...
const LiveTicker: React.FC = () => {
  ...
  return (
    <div className="bg-zoyd-white-5 border-y border-zoyd-white-10 py-3 overflow-hidden">
        ...
        <div className="flex gap-8 animate-marquee">
          {[...liveMatches, ...liveMatches].map((match, index) => (
            <div key={index} className="flex items-center gap-2 text-sm whitespace-nowrap">
              ...
              <span className="text-zoyd-white font-display font-semibold">
                {match.player1} vs {match.player2}
              </span>
              <span className="text-zoyd-white-60">|</span>
              <span className="text-zoyd-white-60">{match.format}</span>
              <span className="text-zoyd-white-60">|</span>
              <span className="text-zoyd-yellow font-display font-bold">{formatZC(match.pot)}</span>
              <span className="text-zoyd-white-60">|</span>
              <span className="text-zoyd-white-60 uppercase">
