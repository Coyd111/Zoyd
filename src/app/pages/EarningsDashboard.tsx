...
const EarningsDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-dvh bg-zoyd-black p-4 md:p-8 font-ui scanline relative overflow-hidden pt-safe-top">
      <SEOHead title="Gains — ZOYD" description="Consulte tes gains et performances sur ZOYD." path="/earnings" noindex />
      <div className="fixed inset-0 tactical-grid opacity-10 pointer-events-none" />

      <div className="max-w-7xl mx-auto relative z-10">
        <header className="mb-10 relative overflow-hidden border border-white/5">
          <img src="/assets/images/codm-3.jpg" alt="" loading="lazy" className="absolute inset-0 w-full h-full object-cover opacity-10 mix-blend-luminosity grayscale pointer-events-none" />
              ...
              <Card className="bg-zoyd-surface/20 border-white/5 hover:border-white/10 transition-all group">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <Badge variant="default" className="bg-white/5 text-[10px] font-mono">
                      TON COMPTE
                    </Badge>
                  </div>
                  <div>
