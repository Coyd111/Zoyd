    ...
    <div className="min-h-dvh bg-zoyd-black text-white scanline font-ui">
      ...
      <header className="relative border-b border-white/5 bg-zoyd-black pt-14 md:pt-16 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="/assets/images/hero/military-action-07.jpg" alt="" loading="lazy" className="w-full h-full object-cover opacity-20 mix-blend-luminosity grayscale pointer-events-none" />
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8 pb-10 md:pb-20 flex flex-col lg:flex-row justify-between items-start lg:items-end gap-8 md:gap-12">
...
className={`px-3 py-3.5 touch-target text-[10px] font-display font-black tracking-widest uppercase italic transition-all border flex items-center gap-2 ${
          ...
          {filteredMatches.length > 0 ? (
            ...
            <div className="py-20 md:py-40 flex flex-col items-center justify-center text-center border-y border-dashed border-white/10 group bg-zoyd-surface/20">
